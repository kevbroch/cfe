...
#define EI_MINHDR	24	/* enough for fields up to e_version */
...
/* The constant below should refer to whichever structure is bigger! */
#define ELF_EHDRSIZE (sizeof(Elf64_Ehdr))
